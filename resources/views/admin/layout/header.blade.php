...
<div class="row">
	...
	<div class="col-md-6 mb-2">
		<div class="card">
			...
			<div class="card-body">
				<img src="{{ $header->image ? asset('storage/uploads/image/header/'.$header->image ) : asset('templates/frontend/devfolio/assets/img/bg.jpeg' ) }}" width="100%" style="height: 270px; object-fit: cover; object-position: center;">
