	...
	<div class="col-md-6 mb-2">
		<div class="card mb-3" style="max-width: 540px;">
		  <div class="row no-gutters">
		    <div class="col-md-4">
		      <img src="{{ $about->image ? asset('storage/uploads/image/about/'.$about->image ) : asset('templates/frontend/devfolio/assets/img/myfoto.jpeg' ) }}" width="100%" style="height: 270px; object-fit: cover; object-position: center;" class="card-img" alt="...">
		    </div>
		    <div class="col-md-8">
		      <div class="card-body">
