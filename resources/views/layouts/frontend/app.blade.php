...
<body id="page-top">
  ...
  <!-- ======= Intro Section ======= -->
  <div id="home" class="intro route bg-image" style="background-image: url(@if($getHeader) {{ $getHeader->image ? asset('storage/uploads/image/header/'.$getHeader->image ) : asset('templates/frontend/devfolio/assets/img/bg.jpeg' ) }} @else {{asset('templates/frontend/devfolio/assets/img/bg.jpeg' ) }} @endif)">
    <div class="overlay-itro"></div>
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          <!--<p class="display-6 color-d">Hello, world!</p>-->
          <h1 class="intro-title mb-4">{{ $getHeader->up_text ?? 'ARIYANTO, S.Kom' }}</h1>
          <p class="intro-subtitle"><span class="text-slider-items">{{ $getHeader->down_text ?? 'Software Developer' }}</span><strong class="text-slider"></strong></p>
                ...
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-sm-6 col-md-5">
                      <div class="about-img">
                        @if($getAbout)
                        <img src="{{ $getAbout->image ? asset('storage/uploads/image/about/'.$getAbout->image ) : asset('templates/frontend/devfolio/assets/img/myfoto.jpeg' ) }}" style="height: 200px; object-fit: cover; object-position: center;" class="img-fluid rounded b-shadow-a" alt="">
                        @else
                        <img src="{{ asset('templates/frontend/devfolio/assets/img/myfoto.jpeg' ) }}" style="height: 200px; object-fit: cover; object-position: center;" class="img-fluid rounded b-shadow-a" alt="">
                        @endif
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-7">
                      <div class="about-info">
                        <p><span class="title-s">Name: </span> <span>{{ $getAbout->name ?? 'Ariyanto, S.Kom' }}</span></p>
                        <p><span class="title-s">Profile: </span> <span>{{ $getAbout->role ?? 'Software Developer' }}</span></p>
                        <p><span class="title-s">Email: </span> <span>{{ $getAbout->email ?? 'antocloud02@gmail.com' }}</span></p>
                        <p><span class="title-s">Phone: </span> <span>{{ $getAbout->phone ?? '+6289678169933' }}</span></p>
                      </div>
                    </div>
                  </div>
                  @if($getSkill->count()>0)  
                ...
                <div class="row">
                  <div class="col-md-6 mx-auto">
                    ...
                    <div class="more-info">
                      ...
                      <ul class="list-ico">
                        <li><span class="ion-ios-location"></span> {{ $getFooter->address ?? 'Jl. Poros Bulo, Timoreng Panua, Kec. Panca Rijang, Kabupaten Sidenreng Rappang, Sulawesi Selatan 91651'  }}</li>
                        <li><span class="ion-ios-telephone"></span> {{ $getFooter->phone ?? '+6289678169933'  }}</li>
                        <li><span class="ion-email"></span> {{ $getFooter->email ?? 'antocloud02@gmail.com'  }}</li>
                      </ul>
                    </div>
                  </div>
                </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="copyright-box">
            <p class="copyright">&copy; Copyright <strong>{{ $getFooter->copyright ?? 'ARIYANTO, S.Kom.'  }}</strong>. All Rights Reserved</p>
            <div class="credits">
              <!--
